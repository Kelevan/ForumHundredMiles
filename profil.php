                    ...
                    <form class=" well form-horizontal">
                        <fieldset>
                            <div class="control-group">
                                <label class="control-label" for="inputpseudo"><b>Pseudo</b></label>
                                <div class="controls">
                                    <span class="input-small uneditable-input">Tom</span>
                                </div> 
                                
                                <label class="control-label" for="inputemail"><b>Adresse&nbsp;e-mail</b></label>
                                <div class="controls">
                                    <input type="text" class="input-medium" id="inputemail" placeholder="Email">
