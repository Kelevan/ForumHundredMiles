        ...
        <div class="span12">
          <div class="hero-unit">
            ...
            <ul>
                ...
                <li><a class="btn btn-primary" href="./gestionCategorie">Gestion des catégories</a></li><br/>
                <li><a class="btn btn-primary" href="./gestionForum">Gestion des forums</a></li><br/>
                <li><a class="btn btn-primary" href="./gestionDroit">Gestion des droits</a></li>
            </ul>
    </div>
