  ...
  <body>
    ...
    <div class="container">
      <div class="row">          
        <div class="span12">
          <div class="hero-unit">
            <h3>Gestion des forums</h3><br/>
            <ul>
                <li><a class="btn btn-primary" href="./addForum.php">Ajouter un forum</a></li><br/>
                <li><a class="btn btn-primary" href="./editMembre.php">Modifier un forum</a></li><br/>
                <li><a class="btn btn-primary" href="./supprForum.php">Supprimer un forum</a></li><br/>
            </ul>
    </div>
